...
export default function HomeTemplate() {
  ...
  return (
    <>
      ...
      <div onClick={hide}>
        <button style={{position:'fixed', bottom:'20px', right:'20px', backgroundColor:'#007bff', color:'#fff', border:'none', padding:'10px 20px', fontSize:'16px', cursor:'pointer', zIndex:'999'}} onClick={hide}>Close</button>
